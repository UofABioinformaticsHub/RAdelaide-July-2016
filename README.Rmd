...
| ------ | ---------------------------------- | ----------------------------- | ------------------------- |
|9:00am  | Introduction to `R Studio`         | Understanding Data Types in `R` | Advanced Programming Using `magrittr`   |  
|10:30am | *Morning Tea*                      | *Morning Tea*                   | *Morning Tea*                    |
|11:00am | Manipulating Data Using `dplyr`        | Writing Functions in `R`        | `R` In the Genomics Era  |
