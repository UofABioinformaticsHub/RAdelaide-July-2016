...
- Running in series took `r times$series[3]` sec
- Running in parallel took `r times$parallel[3]` sec

## Running in Parallel

With 3 cores: a speed up of `r round(times$series[3] / times$parallel[3], 2)`-fold

Now imagine a set of 25,000 SNPs with pair-wise comparisons required for linkage

- That's `r format(choose(25000, 2), big.mark = ",")` comparisons
